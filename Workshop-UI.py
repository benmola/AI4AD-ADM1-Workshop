...
grass_slider = FloatSlider(min=0, max=100, step=10, value=30, description='Grass (%)')
food_slider = FloatSlider(min=0, max=100, step=10, value=10, description='Food (%)')
cattle_slider = FloatSlider(min=0, max=100, step=10, value=10, description='Slurry (%)')
